...
HD_PWD='C:/Users/Thanmayee/full_adder_01/full_adder_01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_dataflow.tcl
